<?php
  ...
  use App\Models\HitungSuaraCalon;
...
//      $hitung = HitungCepat::all();
      ...
      $kota = Indonesia::findCity('7312', ['districts']);
      $kecamatan = $kota->districts()->get();

      return view('pages.hitung-suara-calon.index', compact('kecamatan'));
    }
    ...
    public function create(Request $request)
    {
      ...
      return view('pages.hitung-suara-calon.partial._form-add', compact('calon'));
    }
...
//      $kecamatan = $kota->districts()->pluck('name as nama_kecamatan', 'id as kecid');
      ...
      return view('pages.hitung-suara-calon.partial._form-edit', compact('id', 'model', 'calon', 'kecamatan', 'desa'));
    }
    ...
    public function getHitungSuaraData()
    {
      $query = DB::table('hitung_suara')
        ->select([
          ...
          'indonesia_villages.id as id_desa',
        ...
        ->leftJoin('indonesia_districts', 'indonesia_districts.id', '=', 'hitung_suara.kecamatan')
        ->leftJoin('indonesia_villages', 'indonesia_villages.id', '=', 'hitung_suara.desa')
        ->where('indonesia_districts.city_id', '7312')
      ...
      return Datatables::of($query)
        ...
        ->addColumn('action', function ($hitung) {
          ...
          return view('pages.hitung-suara-calon.buttons', compact('edit', 'delete', 'format'));
        })
