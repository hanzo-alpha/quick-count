 ...
 */
    ...
    namespace Illuminate\Support\Facades {
        ...
        use Illuminate\Filesystem\TWhenReturnType;
     ...
     */
         ...
         *
         * @return \Illuminate\Database\array<string, Connection>
         * @static
         */
...
')
     ...
     */
        ...
        public static function macro($name, $macro)
        {
                        FlashNotifier::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        FlashNotifier::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return FlashNotifier::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
     ...
     */
         ...
         *
         *
         * @see \Yajra\DataTables\DataTablesServiceProvider::boot()
         * @static
         */
        public static function resource()
        {
                        return \Yajra\DataTables\DataTables::resource();
        }
...
namespace  {
    ...
    use Illuminate\Database\Eloquent\TUnlessReturnType;
    use Illuminate\Database\Eloquent\TWhenReturnType;
    ...
    class App extends \Illuminate\Support\Facades\App {}
             ...
             * @param  Closure|null $callback
             * @return Model|\Illuminate\Database\Eloquent\Collection|static[]|static|mixed
             * @static
             */
             ...
             *
             * @param Model|\Illuminate\Database\Eloquent\Collection<Model> $related
             ...
             *
             * @param  Closure|Builder|\Illuminate\Database\Eloquent\Builder|Expression|string $column
...
class Helper
{
    public static function applClasses()
    {
        ...
        $allOptions = [
          ...
          'defaultLanguage'=>array('en' => 'en','id' => 'id'),
