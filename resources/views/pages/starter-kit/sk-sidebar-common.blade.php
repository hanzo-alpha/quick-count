<div class="sidebar-content card d-none d-lg-block">
    <div class="card-body">
        ...
        <div class="text-center">
            <img class="card-img-top mb-1 img-fluid" data-src="holder.js/100px180/"
                src="images/portfolio/portfolio-1.jpg" alt="Card image cap">
        </div>
        ...
        <div class="media">
            <a class="pr-1" href="#">
                <img class="media-object" src="{{asset('images/portrait/small/avatar-s-3.jpg')}}"
